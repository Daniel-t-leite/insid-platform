...
def inicializar_bd():
    with closing(conectar_db()) as conn:
        ...
        # Relaciona Modos de Falha com Anomalias
        # cursor.execute("""
        # CREATE TABLE IF NOT EXISTS modo_falha_anomalia (
        #     modo_falha_id INTEGER NOT NULL,
        #     anomalia_id INTEGER NOT NULL,
        #     FOREIGN KEY (modo_falha_id) REFERENCES modos_falha(id) ON DELETE CASCADE,
        #     FOREIGN KEY (anomalia_id) REFERENCES anomalias(id) ON DELETE CASCADE,
        #     PRIMARY KEY (modo_falha_id, anomalia_id)
        # );
        # """)
        ...
        CREATE TABLE IF NOT EXISTS anomalia_zona (
            ...
            FOREIGN KEY (anomalia_id) REFERENCES anomalias(id) ON DELETE CASCADE,
            FOREIGN KEY (zona_id) REFERENCES zonas_barragem(id) ON DELETE CASCADE,
